    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-base text-gray-900 ">{{ __('Remember me') }}</span>
            </label>
        </div>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ml-3" style="background-color: darkblue; border-radius: 4px; padding: 15px; padding: right 10px;">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
