...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('timesheets', function (Blueprint $table) {
            ...
            $table->float('mon_hours')->default(0.0)->nullable();
            $table->float('tue_hours')->default(0.0)->nullable();
            $table->float('wed_hours')->default(0.0)->nullable();
            $table->float('thurs_hours')->default(0.0)->nullable();
            $table->float('fri_hours')->default(0.0)->nullable();
            $table->float('sat_hours')->default(0.0)->nullable();
            $table->float('sun_hours')->default(0.0)->nullable();
